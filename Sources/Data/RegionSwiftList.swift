...
enum RegionSwiftList {
    static let regions: [RegionSwift] = [
        ...
        RegionSwift(name: "Okinawa.swift", imageFilePath: "/images/regions/okinawaswift.jpg", link: URL(string: "https://japan-region-swift.connpass.com/event/370422/")!),
        RegionSwift(name: "Hakodate.swift", imageFilePath: "/images/regions/hakodateswift.png", link: URL(string: "https://japan-region-swift.connpass.com/event/371217/")!),
    ]
